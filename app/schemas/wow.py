...
class WoWDecision(BaseSchema):
    ...
    earliest_start: datetime | None = Field(None, description="Earliest safe start time")
    recommended_start: datetime | None = Field(None, description="Recommended start time")
